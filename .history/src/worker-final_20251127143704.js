...
import { buildBetrixHeader, buildMatchCard, buildMatchStats, buildMatchActionButtons, buildLeagueSelectorKeyboard, buildBetAnalysis, buildUpcomingFixtures, buildSubscriptionComparison, buildLiveMatchTicker, buildTeamComparison, buildNotificationAlert } from "./utils/premium-ui-builder.js";
import { analyzeMatch, analyzeFormData, analyzeHeadToHead, analyzeOffensivePower, analyzeDefensiveStrength, analyzeInjuries, analyzeOddsPrediction, findValueBets, generateFinalPrediction, calculateConfidence } from "./utils/advanced-match-analysis.js";
import { getLeagueFixtures, getTodayMatches, getUpcomingWeek, formatMatch, buildFixtureBrowserKeyboard, getTodaySummary, getFeaturedMatches, getMatchesByTeams, formatMatchPreview, getHighConfidenceMatches, getValueBetMatches } from "./utils/fixtures-manager.js";
import { buildContextualMainMenu, buildQuickActionMenu, buildSportSelectorMenu, buildLeagueBrowserMenu, buildMatchDetailMenu, buildPremiumFeaturesMenu, buildConfirmationMenu, buildProgressIndicator, buildErrorRecoveryMenu } from "./utils/intelligent-menu-builder.js";
import { BETRIX_BRANDING, generateBetrixHeader, generateBetrixFooter, formatMatchDisplay, formatBetrixError, formatBetrixSuccess, displayTierComparison, formatNotification, formatTeamName, formatLeagueName, generateDivider, formatCurrency, formatPercentageBar } from "./utils/betrix-branding.js";
import { smartCache, batchCache, prefetchData, trackResponseTime, getMetrics, resetMetrics, clearCaches, optimizePayload, encodeResponse, createDebounce, createThrottle, getMemoryReport, buildOptimizedQuery, createRateLimiter } from "./utils/performance-optimizer.js";
