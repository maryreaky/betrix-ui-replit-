...
function normalizeSportsDataEvent(it) {
  ...
  try {
    ...
    /**
     * Cleaned Telegram Handler v2
     * - Restores a minimal, working callback & message handler
     * - Preserves pagination + match/odds routes
     * - Avoids referencing corrupted/undefined UI helpers so the worker can start
     */
