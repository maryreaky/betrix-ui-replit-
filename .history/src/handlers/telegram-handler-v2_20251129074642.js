...
\n${card}`, reply_markup, parse_mode: 'Markdown' };
    ...
    if (data.startsWith('menu_live_page') || data.startsWith('menu_live_refresh')) {
      try {
        ...
        // Fallback: send a new message if original message info is unavailable
        return { chat_id: chatId, text: payload.text, reply_markup: payload.reply_markup, parse_mode: 'Markdown' };
      } catch (e) {
